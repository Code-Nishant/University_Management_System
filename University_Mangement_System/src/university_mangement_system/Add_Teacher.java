...
public class Add_Teacher extends JFrame implements ActionListener {
    ...
    JLabel label_Teacher_ID;
    JDateChooser date;
    JComboBox combo_Box_Qulification;
    ...
    Add_Teacher(){
        ...
        JLabel label_TeacherID = new JLabel("Teacher ID");
        label_TeacherID.setBounds(50, 200, 200, 30);
        label_TeacherID.setFont(new Font("Serif", Font.BOLD, 20));
        add(label_TeacherID);
        label_Teacher_ID = new JLabel("Tech"+num);
        label_Teacher_ID.setBounds(250, 200, 200, 30);
        ...
        text_Field_Tenth_Percent.setFont(new Font("Serif", Font.BOLD, 20));
        ...
        text_Field_Twelve_Percent.setFont(new Font("Serif", Font.BOLD, 20));
        ...
        JLabel label_Highest_Qulification= new JLabel("Highest Qulificationn");
        label_Highest_Qulification.setBounds(50, 400, 300, 30);
        label_Highest_Qulification.setFont(new Font("Serif", Font.BOLD, 20));
        add(label_Highest_Qulification);
        String course[]={"B.Tech","M.Tech","B.BA","M.BA","B.Sc","M.Sc","B.COM","M.COM","B.A","M.A"};
        combo_Box_Qulification=new JComboBox(course);
        combo_Box_Qulification.setBounds(250, 400, 150, 30);
        add(combo_Box_Qulification);
    ...
    public void actionPerformed(ActionEvent event){
        if (event.getSource()==submit) {
            ...
            String qulification=(String)(combo_Box_Qulification.getSelectedItem());
            String branch=(String)(combo_Box_Branch.getSelectedItem());

            // query
            try {
                String query="insert into teacher values('"+name+"', '"+father_name+"', '"+teacher_ID+"', '"+dob+"', '"+address+"', '"+phone_Number+"', '"+Email_ID+"', '"+x_Percentage+"', '"+xii_Percetage+"', '"+aadhar_Number+"', '"+qulification+"', '"+branch+"')";
